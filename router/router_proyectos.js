...
router.post("/listaproyectos", async (req, res) => {
    ...
    let qryO = `SELECT CONST_PROYECTOS.IDPROYECTO, CONST_PROYECTOS.PROYECTO, CONST_PROYECTOS.DIRECCION, CONST_PROYECTOS.FECHAINICIO, CONST_PROYECTOS.FECHAFIN, CONST_PROYECTOS.CONTACTO, 
    ...
    let qry = `SELECT CONST_PROYECTOS.IDPROYECTO, 
    CONST_PROYECTOS.PROYECTO, 
