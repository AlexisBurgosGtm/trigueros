...
FROM            CONST_PROYECTOS RIGHT OUTER JOIN
    CONST_CHEQUES LEFT OUTER JOIN
    CONST_ACREEDORES ON CONST_CHEQUES.CODACREEDOR = CONST_ACREEDORES.CODACREEDOR ON CONST_PROYECTOS.IDPROYECTO = CONST_CHEQUES.IDPROYECTO LEFT OUTER JOIN
