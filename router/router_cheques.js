...
router.post("/listadoproyecto", async (req, res) => {
    ...
    CONST_CHEQUES.NUMERO AS NOCHEQUE, CONST_CHEQUES.CANTIDAD AS IMPORTE, 
    CONST_CHEQUES.RECIBE, 
    CONST_CHEQUES.OBS, CONST_CHEQUES.RUBRO, 
    ISNULL(CONST_CONTRATISTAS_PROYECTO.ASIGNACION, 'SN') AS ASIGNACION, 
    ISNULL(CONST_ACREEDORES.DESACREEDOR, CONST_CONTRATANTES.DESCONTRATANTE) AS DESACREEDOR, 
...
FROM            CONST_ACREEDORES RIGHT OUTER JOIN
    ...
    ORDER BY CONST_CHEQUES.TIPOCHEQUE
