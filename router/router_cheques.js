...
router.post("/listadoproyecto", async (req, res) => {
    ...
    ISNULL(CONST_ACREEDORES.TIPO, 'CONTRATANTE') AS TIPO, CONST_PROYECTOS.PROYECTO, CONST_CHEQUES.TIPOCHEQUE, ISNULL(CONST_CHEQUES.USUARIO, '--') AS USUARIO, CONST_CHEQUES.CONCEPTO
